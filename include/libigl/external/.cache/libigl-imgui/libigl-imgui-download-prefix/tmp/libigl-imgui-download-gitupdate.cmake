...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref a37e6e59e72fb07bd787dc7e90f72b9e1928dae7
  WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/libigl-imgui"
...
if("${show_ref_output}" MATCHES "refs/remotes/a37e6e59e72fb07bd787dc7e90f72b9e1928dae7")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "a37e6e59e72fb07bd787dc7e90f72b9e1928dae7")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "a37e6e59e72fb07bd787dc7e90f72b9e1928dae7")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 a37e6e59e72fb07bd787dc7e90f72b9e1928dae7
  WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/libigl-imgui"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Coding/libigl/cmake/../external/libigl-imgui/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Coding/libigl/cmake/../external/libigl-imgui/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout a37e6e59e72fb07bd787dc7e90f72b9e1928dae7
      WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/libigl-imgui"
      RESULT_VARIABLE error_code
      )
    if(error_code)
