...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref release-1.8.1
  WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/googletest"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 release-1.8.1
  WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/googletest"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Coding/libigl/cmake/../external/googletest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Coding/libigl/cmake/../external/googletest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "C:/Program Files/Git/cmd/git.exe" checkout release-1.8.1
      WORKING_DIRECTORY "D:/Coding/libigl/cmake/../external/googletest"
      RESULT_VARIABLE error_code
      )
    if(error_code)
